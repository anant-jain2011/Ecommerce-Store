...
const Post = ({ clearCart, addToCart, product }) => {
                        ...
                        <div className="container px-5 py-12 mx-auto">
                            <div className="lg:w-full mx-auto flex flex-wrap justify-center">
                                ...
                                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                    ...
                                    <input type="text" className="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-pink-200 focus:border-pink-500 text-base pl-3 pr-10 mb-2 mt-12" onChange={onChangePin} />

                                    <button onClick={checkService} className="flex text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded mb-3">Check</button>
