          ...
          <div className="container px-5 py-24 mx-auto">
            ...
            <div className="flex flex-wrap m-4">
              ...
              {Object.keys(products).map((item) => {
                return <Link href={`/products/${products[item].slug}`}>
                  <div key={item._id} className="lg:w-1/4 md:w-1/2 p-4 w-full h-full m-0.1 shadow-3xl">
                    <a className="flex relative h-96 rounded overflow-hidden">
